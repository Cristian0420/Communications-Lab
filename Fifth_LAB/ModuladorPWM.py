...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "ModuladorPWM")
        ...
        # Blocks
        ##################################################
        self._off_range = Range(-2, 2, 0.01, 0, 200)
        self._off_win = RangeWidget(self._off_range, self.set_off, 'Offset', "counter_slider", float)
        ...
        self.epy_block_0 = epy_block_0.Compara()
        self.blocks_throttle_0 = blocks.throttle(gr.sizeof_float*1, samp_rate,True)
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 10000, 2*A, -A+off, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, A, off, 0)
        ...
        self.connect((self.blocks_throttle_0, 0), (self.epy_block_0, 1))
    ...
    def set_off(self, off):
        self.off = off
        self.analog_sig_source_x_0.set_offset(self.off)
        self.analog_sig_source_x_0_0.set_offset(-self.A+self.off)
