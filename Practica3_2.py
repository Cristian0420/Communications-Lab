...
class Practica3_2(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Practica3_2")
        ...
        # Variables
        ##################################################
        self.samp_rate = samp_rate = 3360
        self.amplitud = amplitud = 1

        ##################################################
        # Blocks
        ##################################################
        self._amplitud_range = Range(0, 30, 1, 1, 200)
        ...
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 3360, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SAW_WAVE, 50000, amplitud, 0, 0)
        ...
        self.connect((self.blocks_multiply_xx_0, 0), (self.Practica3_0, 0))
