...
class Prueba_calculo_potencia(gr.top_block, Qt.QWidget):

    def __init__(self, I_vect=1024):
        gr.top_block.__init__(self, "Prueba_calculo_potencia")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Prueba_calculo_potencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "Prueba_calculo_potencia")
...
def main(top_block_cls=Prueba_calculo_potencia, options=None):
    if options is None:
