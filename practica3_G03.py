...
class practica3_G03(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "practica3_G03")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("practica3_G03")
        ...
        self.settings = Qt.QSettings("GNU Radio", "practica3_G03")
        ...
        # Blocks
        ##################################################
        self._Amplitude_range = Range(0, 200, 20, 50, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, 1000, Amplitude, 0, 0)
...
def main(top_block_cls=practica3_G03, options=None):
